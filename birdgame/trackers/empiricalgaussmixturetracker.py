...
# crunchz/games/birdmodels/empirialgaussbird.py

class EmpiricalGaussMixtureTracker:
    """
...
if __name__ == '__main__':
    tracker = EmpiricalGaussMixtureTracker()
